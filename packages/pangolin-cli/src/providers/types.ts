...
// (Claude Code agents/skills, Cursor rules, etc.) as pangolin-native shapes.
// Providers are pure data adapters: they read filesystem, they do NOT call
// the PangolinClient or do registration. The cmd-* files orchestrate by taking
...
import type { VerifyConfig } from '@quarry-systems/pangolin-client';
