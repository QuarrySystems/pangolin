...
describe('agora-cli scaffold shape', () => {
  describe('package.json', () => {
    ...
    it('has the correct package name', () => {
      expect(pkg.name).toBe('@quarry-systems/agora-cli');
    });

    it('declares bin.agora pointing at dist/index.js', () => {
      const bin = pkg.bin as Record<string, string> | undefined;
      expect(bin).toBeDefined();
      expect(bin?.agora).toBe('dist/index.js');
    });

    it('declares @quarry-systems/agora-client as a workspace dependency', () => {
      const deps = pkg.dependencies as Record<string, string> | undefined;
      expect(deps).toBeDefined();
      expect(deps?.['@quarry-systems/agora-client']).toBe('workspace:*');
    });
