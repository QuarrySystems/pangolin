...
//
// The worker boots with its own process.env: the Agora control-plane vars
// (AGORA_*), the ambient AWS task-role credential chain it uses to fetch
 ...
 *   - starts with the `AGORA_` control-plane prefix, OR
