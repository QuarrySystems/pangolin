// agora-worker: block-pipeline interpreter (Wave 1, §5 of block-runner design).
//
// Provides:
...
//   (a) PipelineSpec is DATA in agora-core; BlockContext (runtime concerns) lives here ONLY.
//   (b) BlockContext is never exported from agora-core.
...
/** Worker-side runtime context — NEVER exported from agora-core (guardrail b). */
