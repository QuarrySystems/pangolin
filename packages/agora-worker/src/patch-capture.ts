// agora-worker: git-based workspace diff capturer
//
...
//                         excluding .agora/. Pure of storage/sentinel concerns.
 ...
 * context:
 *   -c safe.directory=* -c user.email=agora@local -c user.name=agora
 ...
 * shell quoting issues with the ':(exclude).agora' pathspec.
 */
