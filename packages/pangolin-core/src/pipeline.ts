// @quarry-systems/pangolin-core — pipeline contract (Wave 1, §4 of block-runner design).
//
// DATA only: what a pipeline IS. How it RUNS lives in pangolin-worker.
// No zod, no new dependencies. Runtime-only context (guardrail b) lives in pangolin-worker.
 ...
 *
 * Callers: `registerPipeline` (client), `pangolin pipeline validate` (CLI),
