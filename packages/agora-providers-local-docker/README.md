...
```bash
pnpm add @quarry-systems/agora-providers-local-docker
```
...
- [§7.4 Image pinning](../../docs/superpowers/specs/2026-05-21-agora-mvp-design.md#74-image-pinning) — the digest-pin requirement this provider enforces by default.
